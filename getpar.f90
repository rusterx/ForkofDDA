...
! elements of READNF_BCOM
    ...
    YMAX=(X0(2)+NY+0.5001)*DPHYS-0.00001
    ZMIN=(X0(3)+1.-0.5001)*DPHYS+0.00001
    ZMAX=(X0(3)+NZ+0.5001)*DPHYS-0.00001
...
1080 FORMAT(F8.5,F9.5,F4.1,2F8.5,F4.1,' 200 200 1 = XMIN(',F8.5,'),YMIN(',F8.5&
